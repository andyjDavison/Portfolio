export function About() {
  return (
    ...
    //   <p>
    //     Welcome!<br></br>My name is Andrew Davison, I am currently a senior at
    //     the University of South Carolina, where I study Computer Science.
    //     <br></br>Below are some important links with more information about my
    //     work!
    //   </p>
    ...
    //       <div className="button--span">
    //         <a
    //           href="mailto:andy@thedavisonfamily.org"
    //           target="_blank"
    //           rel="noreferrer"
    //         >
    //           <button>
    //             <img
    //               src="/assets/mail_icon.jpg"
    //               alt=""
    //               className="button-img"
    //             />
    //             Email
